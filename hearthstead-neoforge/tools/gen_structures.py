...
(big-endian, gzip-compressed, DataVersion 3955) into
src/main/resources/data/hearthstead/structure/ for use with the Forge
GameTest framework.
...
DATA_VERSION = 3955  # Minecraft 1.20.1

REPO_ROOT = Path(__file__).resolve().parent.parent
OUT_DIR = REPO_ROOT / "src" / "main" / "resources" / "data" / "hearthstead" / "structure"
